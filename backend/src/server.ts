...
8. wifi_key: Senha padrão do Wi-Fi. ATENÇÃO MÁXIMA À EXATIDÃO: Diferencie claramente letras maiúsculas de minúsculas (EX: 'I' maiúsculo vs 'i' minúsculo, 'X' maiúsculo vs 'x' minúsculo, 'C' vs 'c', 'S' vs 's'). CUIDADO REDOBRADO com caracteres impressos muito próximos ou colados ao símbolo de porcentagem '%', não invente caracteres. Diferencie rigorosamente 'O' de '0', e o símbolo de exclamação '!' da letra 'I' maiúscula, da letra 'l' minúscula e do número '1'. Preserve a capitalização exata da imagem. NUNCA adicione ou deduza caracteres.
9. usuario: Usuário padrão de acesso web (geralmente admin, user, etc.).
10. web_key: Senha de acesso web (Password/Senha). ATENÇÃO MÁXIMA À EXATIDÃO: Pode conter caracteres especiais. É EXTREMAMENTE CRÍTICO diferenciar letras MAIÚSCULAS de minúsculas (EX: cuidado redobrado com 'I' maiúsculo vs 'i' minúsculo, 'X' maiúsculo vs 'x' minúsculo, 'C' vs 'c', 'S' vs 's', 'Z' vs 'z', 'W' vs 'w'). CUIDADO REDOBRADO com caracteres impressos muito próximos ou colados ao símbolo de porcentagem '%', não invente caracteres que não existem. Tenha CUIDADO ABSOLUTO para não confundir o símbolo de exclamação '!' com a letra 'I' maiúscula, com o 'l' minúsculo ou com o número '1'. Leia exatamente o que está impresso. NUNCA adicione caracteres extras e respeite rigorosamente a capitalização.
