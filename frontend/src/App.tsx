...
export default function App() {
  ...
  // Controle do botão Voltar do navegador para retornar ao menu de seleção
  useEffect(() => {
    if (activeModule && activeModule !== 'selection') {
      window.history.pushState({ module: activeModule }, '');
    }
  }, [activeModule]);
