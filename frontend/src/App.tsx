            ...
            <div className="p-4 border-t border-white/10 bg-[#002f55]">
              <div className="flex items-center justify-between">
                <div className="overflow-hidden mr-2">
                  ...
                  <p className="text-[10px] text-blue-200/70 font-medium capitalize">{user?.role === 'master' ? 'Master' : user?.role === 'consulta' ? 'Técnico' : user?.role === 'operador' ? 'Operador - Smart Scan' : 'Administrador'} • v1.3.9</p>
                </div>
